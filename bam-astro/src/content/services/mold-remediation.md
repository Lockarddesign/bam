...
category: "core"
shortDescription: "Institutional-grade remediation for HVAC systems and structural surfaces. Safe, contained, and documented removal."
...
heroImage: "/images/jobs/flex-duct-interior-inspection-1_05-05-2025.jpg"
...
diagnostics:
  ...
  items:
    - title: "HVAC Amplification"
      description: "Growth inside ducts or AHUs spreads spores throughout the building."
    ...
    - title: "Containment"
      description: "Preventing migration of spores during the removal process."
    ...
    - title: "Root Cause"
      description: "Identifying the moisture source that allowed growth to occur."
    ...
    - title: "Clearance"
      description: "Verifying safe occupancy levels after work is complete."
...
protocol:
  ...
  steps:
    ...
    - title: "Source Removal"
      description: "Physical removal of microbial growth from surfaces."
      details:
        - "HEPA vacuuming"
        - "Damp wiping"
        - "Abrasive cleaning"
    - title: "HVAC Cleaning"
      description: "Remediating associated ductwork and air handling components."
      details:
        - "Coil disinfection"
        - "Liner encapsulation"
        - "Diffuser cleaning"
    - title: "Clearance Testing"
      description: "Final verification by third-party industrial hygienist (optional)."
      details:
        - "Visual inspection"
        - "Air sampling"
        - "Turnover to owner"
