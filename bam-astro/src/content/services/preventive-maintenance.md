...
category: "core"
shortDescription: "Customized PM agreements for critical cooling assets. We move beyond filter changes to deep technical inspection and hygiene."
icon: '<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>'
heroImage: "/images/jobs/duct-interior-junction-light-tack-tape_11-03-2025.jpg"
...
diagnostics:
  ...
  items:
    - title: "Uptime"
      description: "Preventing emergency failures during peak load seasons."
    ...
    - title: "Efficiency"
      description: "Keeping heat transfer surfaces clean to minimize energy use."
    ...
    - title: "Hygiene"
      description: "Regular disinfection of towers and coils for safety."
    ...
    - title: "Documentation"
      description: "Building a service history for audits and capital planning."
      icon: '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M8 7v7"/><path d="M12 7v4"/><path d="M16 7v10"/></svg>'

protocol:
  title: "Institutional PM Scope"
  description: "A typical BAM maintenance visit is thorough and technically focused."
  steps:
    - title: "Seasonal Start-Up/Shut-Down"
      description: "Proper winterization and spring commissioning of cooling towers."
      details:
        - "Sump cleaning"
        - "Fill inspection"
        - "Motor amp checks"
    - title: "Mid-Season Hygiene"
      description: "Active-season cleaning to control biological loading."
      details:
        - "Online basin cleaning"
        - "Drift eliminator check"
        - "Nozzle inspection"
    - title: "Coil Maintenance"
      description: "Annual deep cleaning of evaporator and condenser coils."
      details:
        - "Enzyme cleaning"
        - "Comb straightening"
        - "Drain line clearing"
    - title: "Belt & Drive Service"
      description: "Inspection and adjustment of power transmission components."
      details:
        - "Belt tensioning"
        - "Sheave alignment"
        - "Bearing lubrication"
